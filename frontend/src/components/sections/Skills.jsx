...
const ICONS = {
  ...
  Databases: 'M4 6c0-1.7 3.6-3 8-3s8 1.3 8 3-3.6 3-8 3-8-1.3-8-3zm0 0v12c0 1.7 3.6 3 8 3s8-1.3 8-3V6M4 12c0 1.7 3.6 3 8 3s8-1.3 8-3',
    ...
    <section id="skills" aria-labelledby="skills-title" className="bg-surface-2/50 px-4 py-20">
      <div className="mx-auto max-w-6xl">
        <Reveal>
          ...
          <p className="mt-4 max-w-2xl text-muted">Tools and practices I&apos;ve used in real projects, grouped by area.</p>
        </Reveal>
          ...
          {profile.skills.map((group) => (
            <Reveal as="li" key={group.category} className="card p-6">
              <div className="flex items-center gap-3">
                <span className="flex h-10 w-10 items-center justify-center rounded-lg bg-accent-soft text-accent" aria-hidden="true">
